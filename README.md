...
Award seat watcher for Seats.aero with push notifications via Discord, driven by a GitHub Actions schedule and configured through a web dashboard.
...
- **Monitor** (`scripts/check-award-seat.mjs`): queries Seats.aero and sends rich Discord embed notifications with flight numbers, departure/arrival times, duration, stops, aircraft, seat counts, points and taxes.
